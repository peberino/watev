...
// clueGame.confidentialCard.murderer = clueGame.characters[0];
// clueGame.confidentialCard.weapon = clueGame.weapons[2];
// clueGame.confidentialCard.room = clueGame.rooms[3];

// // Confidential card information
// const { murderer, weapon, room } = clueGame.confidentialCard;
...
// const mappedSuspects = suspects.map(createSuspectObjects);
